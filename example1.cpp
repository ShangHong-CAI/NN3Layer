...
main(int argc, char** argv)
  ...
  mat A(2,3,fill::ones);  // directly specify the matrix size (elements are uninitialised)
  arma::mat B1(2,3,fill::randu);
  ...
  arma::mat C1=A%B1;
  C1.print("C1:");
  A.insert_cols(A.n_cols, 1,false);
  A.ones( size(mat(A.n_rows+1,A.n_cols)) );
  A.print("123:");
